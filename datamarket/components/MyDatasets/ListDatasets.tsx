...
export const ListDatasets = ({
  ...
  return (
    <div className="flex flex-col w-full">
      <AddButton />
      <div className="flex flex-wrap justify-center px-1 w-3/5 absolute left-[20%] top-belowNav">
      ...
      <div className="flex justify-end w-[275px] fixed right-0 top-belowNav">
        {sidePanelHidden && (
          <button
        ...
        <div
          className={`border-2 border-lightcoral transition-transform duration-400 ease-in-out h-screen w-1/5 max-w-[200px] bg-white fixed right-0 top-belowNav ${
